...
export type ApproachClaim = { claim: string; claim_type: string; source_type: string; source_reference: string; confidence: string; client_communicable: boolean; limitations: string[] }
export type ApproachOffer = { offer_id: string; source: string; title: string; location: string | null; description_excerpt: string | null; source_urls: string[]; selection_reasons: string[]; warnings: string[] }
export type PhoneDraft = { type: string; target: string; opening: string | null; first_30_seconds: string | null; continuation: string | null; qualification_questions: string[]; meeting_transition: string | null; meeting_transition_after_response: string | null; ready_to_copy: boolean }
